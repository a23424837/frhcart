...
export default function CartProduct({product,removeCartProduct,updateproductcount}) {
const[increament,setIncreament]=useState(false)
  return (
    <div>
   
         <div
                            className="flex flex-col relative min-[500px]:flex-row min-[500px]:items-center gap-5 py-6  border-b border-gray-200 group"id='go'>
    ...
    <i  onClick={()=>removeCartProduct(product.product._id)} className="fa-solid fa-trash cursor-pointer"></i>
    </div>
    </div>
